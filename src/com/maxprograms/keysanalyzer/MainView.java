...
import com.maxprograms.keysanalyzer.views.AboutBox;
import com.maxprograms.keysanalyzer.views.MapSelectorDialog;
import com.maxprograms.keysanalyzer.views.PreferencesDialog;
...
public class MainView {
	...
	public MainView(Display display) {
		...
		table.setFocus();
		if (isMac) {
			table.setBackgroundImage(KeysAnalyzer.getResourceManager().getMacBackground());
		} else {
